...
Статус порушення визначено як «**_Потребує реагування_**», що відповідно до умов проекту «[Майдан Моніторинг: Вибори 2012](http://maidanua.org/vybory2012/page/index/1)» передбачає подання після 30 серпня скарг та звернень у належні інстанції з подальшим висвітленням відповідей цих інстанцій та реакції на порушення.
